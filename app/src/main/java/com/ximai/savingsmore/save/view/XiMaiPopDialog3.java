...
public class XiMaiPopDialog3 extends Dialog implements DialogInterface {
    ...
    public XiMaiPopDialog3(Context context) {
        super(context);
        getWindow().setBackgroundDrawableResource(R.drawable.bg_dialog_shape);
    }

    public XiMaiPopDialog3(Context context, int theme, DialogCallBack dialogcallback, int index) {
        super(context, theme);
    ...
    public XiMaiPopDialog3(Context context, String title_text, String content_text, String ok_text, String cancel_text, int theme, DialogCallBack dialogcallback, int index) {
        super(context, theme);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_pop3);
        ...
        if (index == 1) {
            ...
            cancel.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    XiMaiPopDialog3.this.dismiss();
                    callback.CancleDown(XiMaiPopDialog3.this);
                }
            });
        }
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                XiMaiPopDialog3.this.dismiss();
                callback.OkDown(XiMaiPopDialog3.this);
            }
        });
    }
}