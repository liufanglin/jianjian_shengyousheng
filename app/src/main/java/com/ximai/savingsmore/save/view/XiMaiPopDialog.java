...
//两个按键
public class XiMaiPopDialog extends Dialog implements DialogInterface {
        ...
        public XiMaiPopDialog(Context context, String title_text, String content_text, String ok_text, String cancel_text, int theme, DialogCallBack dialogcallback, int index) {
            super(context, theme);
    ...
    public XiMaiPopDialog(Context context, String title_text, String content_text, String ok_text, String cancel_text, String ok_text_color, String no_text_color, int theme, DialogCallBack dialogcallback, int index) {
        super(context, theme);
        this.title_text = title_text;
        this.content_text = content_text;
        this.ok_text = ok_text;
        ...
        public XiMaiPopDialog(Context context, String title_text, String content_text, String ok_text, int theme, DialogCallBack dialogcallback, int index) {
            super(context, theme);
            this.title_text = title_text;
            this.content_text = content_text;
            this.ok_text = ok_text;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if(index == 1){
	            ...
	            cancel.setOnClickListener(new View.OnClickListener() {
	                public void onClick(View v) {
                        XiMaiPopDialog.this.dismiss();
	                    callback.CancleDown(XiMaiPopDialog.this);
	                }
	            });
            }
            ok.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    XiMaiPopDialog.this.dismiss();
                    callback.OkDown(XiMaiPopDialog.this);
                }
            });
        }
