...
public class MyEaseConversationListFragment extends EaseBaseFragment {
    ...
    protected void initView() {
        ...
        ll_defaultdata = (LinearLayout) getView().findViewById(R.id.ll_defaultdata);
...
//                    message = message - conversation.getUnreadMsgCount();
//
//                    if (message < 0){
//                        PreferencesUtils.putInt(getActivity(), MyUserInfoUtils.getInstance().myUserInfo.NickName, 0);
//                    }else{
...
//        errorItemContainer.setVisibility(View.GONE);
        ...
        if (null == conversationList || conversationList.size() == 0){
            ...
            iv.setBackgroundResource(R.mipmap.pinglun_nocomment);
        }else{
