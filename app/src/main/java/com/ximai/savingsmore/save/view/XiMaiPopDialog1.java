...
//弹框下面是一个文字的说明按钮
public class XiMaiPopDialog1 extends Dialog implements DialogInterface {
        ...
        public XiMaiPopDialog1(Context context, String title_text, String content_text, String ok_text, String cancel_text, int theme, DialogCallBack dialogcallback, int index) {
            super(context, theme);
    ...
    public XiMaiPopDialog1(Context context, String title_text, String content_text, String ok_text, String cancel_text, String ok_text_color, String no_text_color, int theme, DialogCallBack dialogcallback, int index) {
        super(context, theme);
        this.title_text = title_text;
        this.content_text = content_text;
        this.ok_text = ok_text;
        ...
        public XiMaiPopDialog1(Context context, String title_text, String content_text, String ok_text, int theme, DialogCallBack dialogcallback, int index) {
            super(context, theme);
            this.title_text = title_text;
            this.content_text = content_text;
            this.ok_text = ok_text;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if(index == 1){
	            ...
	            cancel.setOnClickListener(new View.OnClickListener() {
	                public void onClick(View v) {
                        XiMaiPopDialog1.this.dismiss();
	                    callback.CancleDown(XiMaiPopDialog1.this);
	                }
	            });
            }
            ok.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    XiMaiPopDialog1.this.dismiss();
                    callback.OkDown(XiMaiPopDialog1.this);
                }
            });
        }
