...
public class SelectSearchPopupWindow extends PopupWindow {
    ...
    public SelectSearchPopupWindow(Activity context, OnClickListener itemsCarOnClick) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.selectsearch_popup_window, null);
