...
public class BusinessRewardAdapter extends RecyclerView.Adapter<BusinessRewardAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        if (null != rewardList){
            String state = rewardList.get(position).State;//红包状态   1：未打开 2：申请中 3：提现成功 4;驳回
            if ("1".equals(state)){
    ...
    public void setOnClickListener(BusinessRewardAdapter.OnItemClickListener listener){
