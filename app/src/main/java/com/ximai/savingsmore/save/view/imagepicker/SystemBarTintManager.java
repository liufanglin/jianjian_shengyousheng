...
public class SystemBarTintManager
{
	 ...
	 * @param enabled True to enable tinting, false to disable it (default).
	 */
	public void setNavigationBarTintEnabled(
			boolean enabled )
	{
	...
	public void setStatusBarTintDrawable(
			Drawable drawable )
	{
		if( mStatusBarAvailable )
		{
	 ...
	 * @param color The color of the background tint.
	 */
	public void setNavigationBarTintColor(
			int color )
	{
		if( mNavBarAvailable )
		{
	 ...
	 * @param res The identifier of the resource.
	 */
	public void setNavigationBarTintResource(
			int res )
	{
		if( mNavBarAvailable )
		{
	 ...
	 */
	@TargetApi( 11 )
	public void setNavigationBarAlpha(
			float alpha )
	{
