package com.ximai.savingsmore.library.pickerview.view;
...
import com.ximai.savingsmore.library.pickerview.adapter.NumericWheelAdapter;
import com.ximai.savingsmore.library.pickerview.lib.WheelView;
import com.ximai.savingsmore.library.pickerview.listener.OnItemSelectedListener;
...
public class WheelTime {
	...
	public void setPicker(int year ,int month ,int day,int h,int m) {
		...
		wv_mins.setCurrentItem(m+5);//推迟5分钟
